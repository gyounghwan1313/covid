...
covid = pd.read_csv("https://raw.githubusercontent.com/gyounghwan1313/covid/master/WHO-COVID-19-global-data.csv")
covid.head()
covid.info()

#2020년 10월 06일을 기준으로 누적 확진자 수와 국가별 gdp, 면적, iq, 삶의 질, 인구수, 출생 및 사망률, 국가 성장률, moral machine의 law, 시민의식
data=pd.read_csv("https://raw.githubusercontent.com/gyounghwan1313/covid/master/covid_country_info.csv",encoding='euc-kr')
data.head()
data.info()
